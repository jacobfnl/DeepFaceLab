        ...
        for opts in output_sample_types:
            ...
            if img_type == SPTF.IMG_LANDMARKS_ARRAY:
                ...
                if ct_mode and isinstance(ct_mode, int) and ct_sample is not None:
                    ...
                    if ct_mode == ColorTransferMode.LCT:
                        img_bgr = imagelib.linear_color_transfer(img_bgr, ct_sample_bgr)

                    elif ColorTransferMode.RCT <= ct_mode <= ColorTransferMode.MASKED_RCT_PAPER_CLIP:
                        ct_options = {
                        ...
                        use_masks, use_paper, use_clip = ct_options[ct_mode]
                        if not use_masks:
                    ...
                    elif ct_mode == ColorTransferMode.MKL:
                        img_bgr = imagelib.color_transfer_mkl (img_bgr, ct_sample_bgr)
