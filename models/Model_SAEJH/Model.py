...
class SAEJHModel(ModelBase):
    ...
    def onGetPreview(self, sample):
        ...
        result += [ ('SAEJH', np.concatenate (st, axis=0 )), ]
        ...
        if self.options['learn_mask']:
            ...
            result += [ ('SAEJH masked', np.concatenate (st_m, axis=0 )), ]
            ...
            result += [('SAEJH background', np.concatenate(st_b, axis=0)), ]
            result += [('SAEJH overlay', np.concatenate(st_p, axis=0)), ]
